    ...
    autos.push('Audi'); //Agregamos el elemnto al final del arreglo
    console.log(autos);
    ...
    console.log(autos instanceof Array) //Preuntamos si la variable es una instancia de la clase Array